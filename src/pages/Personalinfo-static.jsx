...
const DEMO_PROFILE_DATA = [
    ...
    {
        label: "Unique String",
        value: "d3m0-1nv3st0r-k3y-2025",
        className: "text-emerald-400",
        icon: <Check className="w-5 h-5" />,
    },
]

function PersonalInfoStatic() {
    const navigate = useNavigate()
    const [profileImage, setProfileImage] = useState("")
    const [isHovering, setIsHovering] = useState(false)
    const [profileData, setProfileData] = useState(DEMO_PROFILE_DATA)
    ...
    const handleVoteClick = () => {
        navigate("/voting-instructions-static")
    }
    ...
    return (
        <main className="min-h-screen w-screen flex items-center justify-center bg-gradient-to-br from-purple-950 via-purple-800 to-pink-800 overflow-hidden p-4 md:p-8">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10"></div>
            </div>
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                        <motion.div
                            className="px-3 py-2 bg-yellow-500/20 text-yellow-300 rounded-lg text-sm font-medium"
                ...
                >
                    ...
                    <p className="mt-2 text-yellow-300/70">DEMO MODE - No API calls are being made</p>
                </motion.div>
            </motion.div>
        </main>
    )
...
export default PersonalInfoStatic
